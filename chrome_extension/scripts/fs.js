(function(window, fileSystem, util) {
    ...
    navigator.webkitPersistentStorage.queryUsageAndQuota(function(usedBytes, grantedBytes) {
        console.log('we are using ', bytesToSize(usedBytes), ' of ', bytesToSize(grantedBytes));
    })
    ...
    util.requestQuota = function() {
        navigator.webkitPersistentStorage.requestQuota(2222 * 1024 * 1024, util.requestFileSystem, this.errorHandler);
    }
